...
public final class PrefsUtility {
	...
	public static boolean pref_behaviour_use_external_browser_twitter(final Context context, final SharedPreferences sharedPreferences) {
		return getBoolean(R.string.pref_behaviour_use_external_browser_twitter_key, false, context, sharedPreferences);
	}
